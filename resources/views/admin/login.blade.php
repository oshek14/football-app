	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box " style="background-image:url({{asset('/images/login-bg.jpg')}});">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('images/logo-dark.png')}}" alt="Klorofil Logo"></div>
